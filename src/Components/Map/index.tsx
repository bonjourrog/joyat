...
const Map: React.FC<MapProps> = ({position, zoom, markers})=>{
    ...
    return <MapContainer className="map" center={ position } zoom={zoom} scrollWheelZoom={false} zoomControl={false} touchZoom={false} dragging={false} doubleClickZoom={false}>
                <TileLayer
